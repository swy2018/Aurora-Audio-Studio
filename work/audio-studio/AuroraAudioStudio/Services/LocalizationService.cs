...
public sealed class LocalizationService(SettingsService settings)
{
    ...
    {
        ["logEngineStarting"] = ["正在启动引擎：{0}", "正在啟動引擎：{0}", "Starting engine: {0}", "エンジンを起動中：{0}"],
        ["logTaskStarting"] = ["正在执行任务：{0}", "正在執行任務：{0}", "Starting task: {0}", "タスクを開始：{0}"],
        ["logTaskComplete"] = ["任务已完成。", "任務已完成。", "Task completed.", "タスクが完了しました。"],
        ["logTaskExit"] = ["任务未完成（退出码：{0}）。请查看任务日志。", "任務未完成（結束代碼：{0}）。請查看任務記錄。", "Task did not complete (exit code: {0}). See the task log.", "タスクを完了できませんでした（終了コード：{0}）。タスクログをご確認ください。"],
        ["logTaskCanceled"] = ["任务已取消。", "任務已取消。", "Task canceled.", "タスクをキャンセルしました。"],
        ["logOperationFailed"] = ["操作未完成。", "操作未完成。", "Operation did not complete.", "操作を完了できませんでした。"],
        ["logOperationComplete"] = ["操作已完成。", "操作已完成。", "Operation completed.", "操作が完了しました。"],
        ["logMaintenanceStarting"] = ["开始维护模型：{0}", "開始維護模型：{0}", "Starting model maintenance: {0}", "モデルのメンテナンスを開始：{0}"],
        ["logEngineOutput"] = ["以下为引擎或安装工具的原始输出，可能使用其他语言。", "以下為引擎或安裝工具的原始輸出，可能使用其他語言。", "Original engine or installer output follows and may use another language.", "以下はエンジンまたはインストーラーの元の出力です。別の言語が含まれる場合があります。"],
        ["workbenchNotSupported"] = ["此模型不支持内嵌工作台。请在模型中心查看支持范围。", "此模型不支援內嵌工作台。請在模型中心查看支援範圍。", "This model does not support an embedded workbench. See Model Center for supported features.", "このモデルは埋め込みワークベンチに非対応です。モデルセンターで対応機能をご確認ください。"],
        ["taskAlreadyRunning"] = ["另一个本地任务正在运行，请等待完成或取消后重试。", "另一個本機任務正在執行，請等待完成或取消後重試。", "Another local task is running. Wait for it to finish or cancel it before retrying.", "別のローカルタスクが実行中です。完了を待つかキャンセルしてから再試行してください。"],
        ["taskNotSupported"] = ["不支持此任务类型，请重新选择功能。", "不支援此任務類型，請重新選擇功能。", "This task type is not supported. Select another workflow.", "このタスク形式には対応していません。別の機能を選択してください。"],
        ["modelInstallRequired"] = ["尚未安装 {0}，请前往模型中心安装。", "尚未安裝 {0}，請前往模型中心安裝。", "{0} is not installed. Install it in Model Center.", "{0} は未インストールです。モデルセンターでインストールしてください。"],
        ["engineConnected"] = ["已连接本地模型。", "已連線至本機模型。", "Connected to the local model.", "ローカルモデルに接続しました。"],
        ["engineMemoryRequired"] = ["{0} 可用内存不足。可用物理内存：{1} GB；可用提交空间：{2} GB。请关闭其他大型程序后重试。", "{0} 可用記憶體不足。可用實體記憶體：{1} GB；可用認可空間：{2} GB。請關閉其他大型程式後重試。", "Not enough memory for {0}. Available RAM: {1} GB; available commit space: {2} GB. Close other memory-intensive apps and retry.", "{0} に必要なメモリが不足しています。空き物理メモリ：{1} GB、空きコミット領域：{2} GB。メモリを多く使うアプリを終了して再試行してください。"],
        ["engineStartFailed"] = ["引擎启动失败（退出码：{0}）。请查看引擎日志，或在模型中心检查与修复。\n{1}", "引擎啟動失敗（結束代碼：{0}）。請查看引擎記錄，或在模型中心檢查與修復。\n{1}", "Engine startup failed (exit code: {0}). Check the engine log or use Check / Repair in Model Center.\n{1}", "エンジンの起動に失敗しました（終了コード：{0}）。エンジンログを確認するか、モデルセンターで確認・修復してください。\n{1}"],
        ["engineTimeout"] = ["引擎启动超过 5 分钟。请查看引擎日志，或在模型中心检查与修复后重试。", "引擎啟動超過 5 分鐘。請查看引擎記錄，或在模型中心檢查與修復後重試。", "Engine startup exceeded 5 minutes. Check the engine log or repair the model in Model Center before retrying.", "エンジンの起動に5分以上かかっています。ログを確認するか、モデルセンターで修復して再試行してください。"],
        ["logMissing"] = ["尚未生成启动日志。", "尚未產生啟動記錄。", "No startup log has been created.", "起動ログはまだ作成されていません。"],
        ["logEmpty"] = ["启动日志尚无内容。", "啟動記錄尚無內容。", "The startup log is empty.", "起動ログに内容がありません。"],
        ["logUnreadable"] = ["无法读取启动日志。", "無法讀取啟動記錄。", "The startup log could not be read.", "起動ログを読み込めませんでした。"],
        ["logTail"] = ["最近的原始输出：{0}", "最近的原始輸出：{0}", "Recent original output: {0}", "直近の元の出力：{0}"],
        ["logUnknownExit"] = ["未知", "未知", "unknown", "不明"],
        ["applicationBridgeMissing"] = ["工作台组件缺失，请重新安装 Aurora。", "工作台元件缺失，請重新安裝 Aurora。", "A workbench component is missing. Reinstall Aurora.", "ワークベンチのコンポーネントがありません。Aurora を再インストールしてください。"],
        ["engineLaunchInvalid"] = ["工作台启动参数无效，请重新选择模型后重试。", "工作台啟動參數無效，請重新選擇模型後重試。", "Workbench startup options are invalid. Select the model again and retry.", "ワークベンチの起動設定が無効です。モデルを選び直して再試行してください。"],
        ...
        ["正在配置独立模型下载组件"] = ["正在配置独立模型下载组件", "正在設定獨立模型下載元件", "Setting up the model downloader", "モデルのダウンロード用コンポーネントを設定中"],
        ["正在下载模型包"] = ["正在下载模型包", "正在下載模型套件", "Downloading the model package", "モデルパッケージをダウンロード中"],
        ["正在配置 ACE-Step 隔离运行环境"] = ["正在配置 ACE-Step 隔离运行环境", "正在設定 ACE-Step 獨立執行環境", "Setting up the ACE-Step runtime", "ACE-Step の実行環境を設定中"],
        ["正在下载 ACE-Step 基础权重"] = ["正在下载 ACE-Step 基础权重", "正在下載 ACE-Step 基礎模型", "Downloading ACE-Step base model weights", "ACE-Step の基本モデルをダウンロード中"],
        ["正在下载 ACE-Step 1.5 XL Turbo 官方权重"] = ["正在下载 ACE-Step 1.5 XL Turbo 官方权重", "正在下載 ACE-Step 1.5 XL Turbo 官方模型", "Downloading official ACE-Step 1.5 XL Turbo weights", "ACE-Step 1.5 XL Turbo の公式モデルをダウンロード中"],
        ["正在配置 Seed-VC Python 3.10 隔离环境"] = ["正在配置 Seed-VC Python 3.10 隔离环境", "正在設定 Seed-VC Python 3.10 獨立環境", "Setting up the Seed-VC Python 3.10 runtime", "Seed-VC の Python 3.10 実行環境を設定中"],
        ["正在下载 Seed-VC 官方权重与配置"] = ["正在下载 Seed-VC 官方权重与配置", "正在下載 Seed-VC 官方模型與設定", "Downloading official Seed-VC weights and configuration", "Seed-VC の公式モデルと設定をダウンロード中"],
        ["正在下载 BS-RoFormer-SW 多轨权重"] = ["正在下载 BS-RoFormer-SW 多轨权重", "正在下載 BS-RoFormer-SW 多軌模型", "Downloading BS-RoFormer-SW multistem weights", "BS-RoFormer-SW のマルチステムモデルをダウンロード中"],
        ["正在下载 YourMT3+ 多乐器权重"] = ["正在下载 YourMT3+ 多乐器权重", "正在下載 YourMT3+ 多樂器模型", "Downloading YourMT3+ multi-instrument weights", "YourMT3+ の複数楽器モデルをダウンロード中"],
        ["正在下载并配置 MiniMax-Music3 CUDA 运行环境（PyTorch 组件较大，请耐心等待）"] = ["正在下载并配置 MiniMax-Music3 CUDA 运行环境（PyTorch 组件较大，请耐心等待）", "正在下載並設定 MiniMax-Music3 CUDA 環境，可能需要較長時間", "Downloading and setting up the MiniMax-Music3 CUDA runtime; large components may take some time", "MiniMax-Music3 の CUDA 環境を設定中です。容量が大きいため時間がかかる場合があります"],
        ["正在下载 MiniMax-Music3 官方模型（约 27 GB）"] = ["正在下载 MiniMax-Music3 官方模型（约 27 GB）", "正在下載 MiniMax-Music3 官方模型（約 27 GB）", "Downloading the official MiniMax-Music3 model (about 27 GB)", "MiniMax-Music3 の公式モデルをダウンロード中（約 27 GB）"],
        ["正在创建 Qwen3-TTS Python 3.12 隔离环境"] = ["正在创建 Qwen3-TTS Python 3.12 隔离环境", "正在建立 Qwen3-TTS Python 3.12 獨立環境", "Creating the Qwen3-TTS Python 3.12 runtime", "Qwen3-TTS の Python 3.12 実行環境を作成中"],
        ["正在安装 Qwen3-TTS 所需的 SoX 音频组件"] = ["正在安装 Qwen3-TTS 所需的 SoX 音频组件", "正在安裝 Qwen3-TTS 所需的 SoX 音訊元件", "Installing SoX audio components for Qwen3-TTS", "Qwen3-TTS 用の SoX 音声コンポーネントをインストール中"],
        ["正在安装 FFmpeg 音频组件"] = ["正在安装 FFmpeg 音频组件", "正在安裝 FFmpeg 音訊元件", "Installing FFmpeg audio components", "FFmpeg 音声コンポーネントをインストール中"],
        ["logWriteFailed"] = ["无法写入运行日志：{0}", "無法寫入執行記錄：{0}", "Could not write the runtime log: {0}", "実行ログを書き込めませんでした：{0}"],
        ["此引擎需要通过 Aurora 安装程序添加运行环境。"] = ["此引擎缺少运行环境，请重新安装或更新 Aurora。", "此引擎缺少執行環境，請重新安裝或更新 Aurora。", "The engine runtime is missing. Reinstall or update Aurora.", "エンジンの実行環境がありません。Aurora を再インストールまたは更新してください。"],
        ["home"] = ["首页", "首頁", "Home", "ホーム"],
        ["macModelCheckUpdates"] = ["检查模型更新", "檢查模型更新", "Checking model updates", "モデルの更新を確認"],
        ["macModelCheck"] = ["校验模型", "驗證模型", "Verifying models", "モデルを検証"],
        ["macModelUpdate"] = ["更新模型", "更新模型", "Updating models", "モデルを更新"],
        ["macModelMaintain"] = ["维护模型", "維護模型", "Maintaining models", "モデルを保守"],
        ["macModelNone"] = ["没有可检查的已安装模型。", "沒有可檢查的已安裝模型。", "No installed models are available to check.", "確認できるインストール済みモデルはありません。"],
        ["macModelSkipped"] = ["另有 {0} 个组件未安装或未适配。", "另有 {0} 個元件未安裝或未適配。", "{0} other components are not installed or supported.", "ほかに {0} 個のコンポーネントが未導入または非対応です。"],
        ["macModelCanceled"] = ["已取消，完成 {0}/{1} 项；已完成检查结果和下载文件保留。", "已取消，完成 {0}/{1} 項；已完成檢查結果和下載檔案保留。", "Canceled after {0}/{1} items; completed checks and downloads are retained.", "キャンセルしました。{0}/{1} 件完了。確認結果とダウンロード済みファイルは保持します。"],
        ["macModelFailed"] = ["完成 {0}/{1} 项，{2} 项失败；可重试。", "完成 {0}/{1} 項，{2} 項失敗；可重試。", "Completed {0}/{1} items; {2} failed and can be retried.", "{0}/{1} 件完了。{2} 件は失敗しました。再試行できます。"],
        ["macModelChecked"] = ["检查完成：{0} 项已检查，发现 {1} 个可更新模型。", "檢查完成：{0} 項已檢查，發現 {1} 個可更新模型。", "Check complete: {0} items checked, {1} model updates available.", "確認完了：{0} 件を確認、{1} 件のモデル更新があります。"],
        ["macModelCompleted"] = ["完成：{0}/{1} 项。", "完成：{0}/{1} 項。", "Completed: {0}/{1} items.", "完了：{0}/{1} 件。"],
        ["toggleOn"] = ["开", "開", "On", "オン"],
        ["toggleOff"] = ["关", "關", "Off", "オフ"],
        ["rollbackApp"] = ["回退到上一个正式版", "回復至上一個正式版", "Revert to previous stable release", "前の正式版に戻す"],
        ["rollbackHint"] = ["适用于正式版和测试版。回退前可确认目标版本；不会更改更新通道。", "適用於正式版與測試版。回復前可確認目標版本；不會變更更新通道。", "Available on Stable and Beta. Review the target version before reverting; your update channel stays unchanged.", "正式版・ベータ版のどちらでも利用できます。対象バージョンを確認して戻せます。更新チャンネルは変わりません。"],
        ["rollbackAvailable"] = ["已找到可回退的正式版。", "已找到可回復的正式版。", "A previous stable release is available.", "戻せる正式版が見つかりました。"],
        ["rollbackUnavailable"] = ["未找到适用于当前平台的更早正式版。当前应用未作更改。", "未找到適用於目前平台的較早正式版。目前應用程式未變更。", "No earlier stable release was found for this platform. The current app is unchanged.", "この環境に対応する以前の正式版が見つかりません。アプリは変更されていません。"],
        ["rollbackInstall"] = ["下载并回退", "下載並回復", "Download and revert", "ダウンロードして戻す"],
        ["rollbackDialogBody"] = ["当前版本：{0}\n回退版本：{1}（正式版）\n\n将下载并校验该版本的安装包，替换当前应用。模型、设置和成品将保留，但旧版可能无法读取较新版本的配置或记录。请先备份重要数据。", "目前版本：{0}\n回復版本：{1}（正式版）\n\n將下載並驗證安裝檔案，取代目前應用程式。模型、設定與成品將保留，但舊版可能無法讀取新版設定或記錄。請先備份重要資料。", "Current version: {0}\nRevert to: {1} (Stable)\n\nDownload and verify the installer to replace the app. Models, settings, and results will be preserved, but older versions may not read newer settings or records. Back up important data first.", "現在のバージョン：{0}\n戻すバージョン：{1}（正式版）\n\n取得・検証後にアプリを置き換えます。モデル、設定、成果は保持しますが、旧版では新しい設定や履歴を読み込めない場合があります。重要なデータを先にバックアップしてください。"],
        ["appReplaceNotice"] = ["安装成功后不保留旧应用副本。安装失败时会尝试恢复原应用；模型与成品不受影响。", "安裝成功後不保留舊應用程式副本。安裝失敗時會嘗試復原原應用程式；模型與成品不受影響。", "No old app copy is retained after successful installation. If replacement fails, the original app is restored where possible. Models and results are unaffected.", "インストール成功後は旧アプリのコピーを保持しません。失敗時は元のアプリの復元を試みます。モデルと成果には影響しません。"],
        ["appInstallComplete"] = ["应用安装已完成。", "應用程式安裝已完成。", "App installation is complete.", "アプリのインストールが完了しました。"],
        ["appInstallBusy"] = ["请先完成或取消运行中的任务，并结束模型工作台，再安装其他版本。", "請先完成或取消執行中的任務，並結束模型工作台，再安裝其他版本。", "Finish or cancel active tasks and close model workbenches before installing another version.", "別のバージョンを導入する前に、タスクを完了またはキャンセルし、モデルのワークベンチを終了してください。"],
        ["repairRuntime"] = ["检查／修复运行环境", "檢查／修復執行環境", "Check / repair runtime", "実行環境の確認・修復"],
        ["repairDownloadSize"] = ["预计下载 {0:0.##} MB，校验后仅补齐清单内文件。", "預計下載 {0:0.##} MB，驗證後僅補齊清單內檔案。", "Download about {0:0.##} MB; only listed files are added after verification.", "約 {0:0.##} MB を取得し、検証後に一覧のファイルのみ補完します。"],
        ["cancelWorkbenchTask"] = ["结束引擎并取消", "結束引擎並取消", "End engine and cancel", "エンジンを終了してキャンセル"],
        ["cancelWorkbenchTaskBody"] = ["这会结束该工作台引擎，并取消其中所有未完成任务。已保存的成品不受影响。是否继续？", "這會結束該工作台引擎，並取消其中所有未完成任務。已儲存的成品不受影響。是否繼續？", "This ends the workbench engine and cancels all unfinished tasks in it. Saved results are kept. Continue?", "このワークベンチのエンジンと未完了タスクをすべて終了します。保存済みの成果は保持されます。続行しますか？"],
        ["文件校验通过；不会重新下载或重装。"] = ["所需文件齐全；不会重新下载或重装。", "所需檔案齊全；不會重新下載或安裝。", "Required files are present; no download or reinstall will run.", "必要なファイルが揃っています。再ダウンロード・再導入は行いません。"],
        ["仅修复运行环境，保留模型权重。依赖包可能重新下载，旧环境保留供回退。"] = ["仅修复运行环境，保留模型权重。依赖包可能重新下载，旧环境保留供回退。", "僅修復執行環境，保留模型權重。可能重新下載依賴套件，舊環境保留供還原。", "Repair only the runtime and keep model weights. Dependencies may be downloaded again; the old runtime is retained for rollback.", "モデルの重みを保持し実行環境のみ修復します。依存パッケージを再取得する場合があります。旧環境は復元用に保持します。"],
        ["只补齐当前版本缺失的权重，不更换运行环境。"] = ["只补齐当前版本缺失的权重，不更换运行环境。", "僅補齊目前版本缺少的權重，不更換執行環境。", "Add only missing weights for the installed revision; keep the runtime.", "導入済みバージョンの不足する重みだけを補完し、実行環境は保持します。"],
        ["无法安全执行局部修复，将使用完整部署流程，并保留可回退版本。"] = ["此问题需要重新安装模型及运行环境。将保留原版本，以便恢复。", "此問題需要重新安裝模型及執行環境。將保留原版本，以便復原。", "This repair requires reinstalling the model and its runtime. The current version will be kept for recovery.", "モデルと実行環境の再インストールが必要です。復元できるように現在のバージョンを保持します。"],
        ["草稿读取失败，原文件已保留。"] = ["草稿读取失败，原文件已保留。", "草稿讀取失敗，原檔案已保留。", "Could not read the draft; the original file is retained.", "下書きを読み込めません。元のファイルは保持されています。"],
        ["草稿保存失败："] = ["草稿保存失败：", "草稿儲存失敗：", "Could not save draft: ", "下書きを保存できません："],
        ["正在收录成品"] = ["正在收录成品", "正在收錄成品", "Adding results to the library", "成果をライブラリに追加中"],
        ["工作台已结束，但未检测到可收录的音频成品。"] = ["生成已结束，但没有可保存的音频。请查看引擎日志后重试。", "生成已結束，但沒有可儲存的音訊。請查看引擎日誌後重試。", "Generation ended without a savable audio result. Check the engine log and retry.", "生成は終了しましたが、保存できる音声がありません。ログを確認して再試行してください。"],
        ["工作台生成未完成，请查看引擎日志。"] = ["工作台生成未完成，请查看引擎日志。", "工作台生成未完成，請查看引擎日誌。", "Generation did not complete. See the engine log.", "生成が完了していません。エンジンのログを確認してください。"],
        ...
        ["本地端口未提供本次引擎的完整工作台，请检查端口占用或修复引擎。"] = ["无法连接所选模型的工作台。请检查引擎日志；如有端口冲突，请关闭占用程序后重试。", "無法連線至所選模型的工作台。請檢查引擎日誌；如有連接埠衝突，請關閉占用程式後重試。", "Cannot connect to the selected model's workbench. Check the engine log; if its port is in use, close the conflicting app and retry.", "選択したモデルに接続できません。ログを確認し、ポートを使用中のアプリがあれば終了して再試行してください。"],
        ...
        ["所选素材已在列表中，无需重复添加。"] = ["所选素材已在列表中，无需重复添加。", "所選素材已在清單中，無需重複加入。", "The selected files are already in the list.", "選択した素材はすでにリストにあります。"],
        ...
        ["homeSubtitle"] = ["选择功能，开始创作。", "選擇功能，開始創作。", "Choose a workflow to start creating.", "機能を選んで制作を始めます。"],
        ...
        ["output"] = ["查看成品", "查看成品", "View results", "成果を表示"],
        ...
        ["maintenanceSubtitle"] = ["检查运行环境、恢复任务并导出诊断信息。", "檢查執行環境、復原任務並匯出診斷資訊。", "Check your setup, recover tasks, and export diagnostics.", "実行環境の確認、タスクの復旧、診断情報の出力。"],
        ["settingsSubtitle"] = ["按你的习惯调整 Aurora。", "依照你的習慣調整 Aurora。", "Adapt Aurora to the way you work.", "作業スタイルに合わせて Aurora を調整します。"],
        ["aboutSubtitle"] = ["版本信息、更新与支持。", "版本資訊、更新與支援。", "Version information, updates, and support.", "バージョン情報、更新、サポート。"],
        ["modelsSubtitle"] = ["查看模型支持情况，管理安装与更新。", "查看模型支援情況，管理安裝與更新。", "Check model support and manage installations and updates.", "モデルの対応状況を確認し、インストールと更新を管理します。"],
        ...
        ["updatePreparingInstall"] = ["正在启动安装程序", "正在啟動安裝程式", "Starting installer", "インストーラーを起動中"],
        ...
        ["updateReady"] = ["发现可安装的更新。", "發現可安裝的更新。", "An update is available to install.", "インストール可能な更新があります。"],
        ...
        ["updateStarted"] = ["安装程序已启动。请按 Windows 提示完成安装，Aurora 将在完成后重新打开。", "安裝程式已啟動。請依 Windows 提示完成安裝，Aurora 將在完成後重新開啟。", "The installer has started. Follow the Windows prompts; Aurora will reopen when installation completes.", "インストーラーを起動しました。Windows の案内に従ってください。完了後に Aurora が再起動します。"],
        ...
        ["updateDialogBody"] = ["当前版本：{0}\n目标版本：{1}\n\n将下载并校验安装包，更新当前应用。模型、设置和成品将保留。", "目前版本：{0}\n目標版本：{1}\n\n將下載並驗證安裝檔案，更新目前應用程式。模型、設定與成品將保留。", "Current version: {0}\nTarget version: {1}\n\nDownload and verify the installer to update the app. Models, settings, and results will be preserved.", "現在のバージョン：{0}\n対象バージョン：{1}\n\nインストーラーを取得・検証し、アプリを更新します。モデル、設定、成果は保持されます。"],
        ...
        ["installModel"] = ["安装模型", "安裝模型", "Install model", "モデルをインストール"],
    ...
    private readonly Dictionary<string, string[]> phrases = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["查看我的成品"] = ["查看成品", "查看成品", "View results", "成果を表示"],
        ...
        ["我的成品"] = ["查看成品", "查看成品", "View results", "成果を表示"],
        ...
        ["开启你的下一次创作"] = ["开始创作", "開始創作", "Start creating", "制作を始める"],
        ["选择创作引擎，即刻在 Aurora 中开始。所有处理均在本机完成。"] = ["选择模型并打开工作台。所有创作任务均在本机处理。", "選擇模型並開啟工作台。所有創作任務均在本機處理。", "Select a model and open its workbench. Creative tasks are processed locally.", "モデルを選んでワークベンチを開きます。制作タスクはローカルで処理されます。"],
        ...
        ["选择音频或视频素材，Aurora 会在本机生成六轨分离结果。"] = ["选择音频或视频素材，Aurora 会按所选模式在本机分离音轨。", "選擇音訊或影片素材，Aurora 會依所選模式在本機分離音軌。", "Choose audio or video and Aurora will separate stems locally using the selected mode.", "音声または動画を選ぶと、選択したモードでローカル分離します。"],
    ...
    [
        ["尚未安装 {0}，请前往模型中心安装。", "尚未安裝 {0}，請前往模型中心安裝。", "{0} is not installed. Install it in Model Center.", "{0} は未インストールです。モデルセンターでインストールしてください。"],
