# Aurora Audio Studio 1.0.0 使用说明
...
6. 未安装的模型会在模型中心显示；只有点击安装并确认后才会下载或部署。
...
BS-RoFormer-SW 6-Stem 可输出人声、鼓、贝斯、吉他、钢琴、其他和纯伴奏，适合翻唱、混音和后续扒谱。
...
Subtitle Edit 与 Faster-Whisper 用于语音识别、时间轴校对和 SRT 导出。人名、术语、歌词和口音内容请人工复核。
...
Aurora 每天首次启动时会自动检查一次，也可以在“关于”页随时点击“检查更新”。如果 GitHub 上有更新，确认后会显示全局下载和 SHA-256 校验进度；随后可见的安装进度窗口接管升级。只有安装成功后才自动打开新版。个人设置、任务记录、模型、项目、成品和原安装目录都会保留。如果已经是最新版，会直接提示无需更新。“检查更新”旁的“更新日志”可查看当前和最近四个版本的更新内容。
