# Aurora Audio Studio 1.9.9 使用说明
...
Aurora 1.9.9 强化六类任务的安装、输出校验、队列恢复与成品操作，并重做四语言切换。WebView2 用户数据继续保存到可写的 `%LOCALAPPDATA%\Aurora Audio Studio\WebView2`。引擎“文件齐全”与“短任务已验证”分开显示；具体实测范围见 [1.9.9 验收记录](../../docs/validation-1.9.9.md)。
