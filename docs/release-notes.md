...
- 本测试版与 1.9.9 正式版功能相同，仅调整版本标识，用于验证测试通道升级；不是 2.0 正式版。
...
- Functionally identical to stable 1.9.9, with version metadata changed to validate beta-channel upgrades. This is not the 2.0 final release.
