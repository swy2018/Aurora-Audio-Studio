...
用户可以在 Aurora 的卸载流程中选择删除本机配置。模型、处理记录、源素材和生成成品不会被卸载程序删除，也可以由用户直接管理。
...
The Aurora uninstaller lets the user choose whether to remove local application settings. Models, processing records, source media, and generated outputs are never removed by the uninstaller and remain under the user's direct control.
