...
- Aurora 不会把用户的声音、音乐、视频、提示词、项目或生成内容发送到 Aurora 运营的服务器。
- 用户选择使用的第三方模型、工具和下载服务受其各自的隐私政策与使用条款约束。

### 用户控制

用户可以在 Aurora 的卸载流程中选择删除本机配置。模型、项目、源素材和生成成品不会被卸载程序删除，也可以由用户直接管理。

隐私问题可通过项目的 [GitHub Issues](https://github.com/swy2018/Aurora-Audio-Studio/issues) 提出。请勿在公开 Issue 中提交私人素材、密码、访问令牌或其他敏感信息。
...
- Projects, source media, models, and generated outputs are stored in directories selected by the user.
...
- Aurora does not transmit voices, music, videos, prompts, projects, or generated content to servers operated by Aurora.
...
The Aurora uninstaller lets the user choose whether to remove local application settings. Models, projects, source media, and generated outputs are never removed by the uninstaller and remain under the user's direct control.

Privacy questions may be submitted through the project's [GitHub Issues](https://github.com/swy2018/Aurora-Audio-Studio/issues). Do not post private media, passwords, access tokens, or other sensitive information in a public issue.
